  ...
  return (
    <div className=" lg:relative overflow-hidden ">
      <div className="md:grid grid-cols-2  ">
        <div className=" relative flex flex-row items-center justify-center space-y-16  ">
          ...
          <div className="   max-w-full max-h-full  hidden md:block">
            ...
            <div className=" grid grid-cols-2  ">
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="absolute left-0 bottom-0 md:visible invisible max-w-full "
              >
        ...
        <div className="relative">
          <div className=" bg-right bg-[url('/HomePage_Image.png')]   bg-no-repeat bg-cover max-w-screen h-screen relative  ">
            <div className="absolute inset-0 bg-black bg-opacity-75 md:hidden"></div>

            <div className="grid grid-rows-6  relative flex items-center justify-center  md:hidden">
              <img
                src="/MACSLOGOTRANS 2.png"
              ...
              <div className="relative row-start-6 flex flex-row items-center justify-center">
                <svg
                  width="27"
                  height="18"
                  viewBox="0 0 27 18"
